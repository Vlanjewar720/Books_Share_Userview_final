...
function Adashboard() {
 ...
 <div className="max-h-[70rem] min-h-[50rem] overflow-y-scroll overflow-x-scroll bg-[#F0ECEC]">
    <div className=" p-5 bg-[#F0ECEC] grid md:grid-cols-2 gap-5 sm:grid-cols-1 xl:grid-cols-2 lg:grid-cols-2">
  
        {books &&
        books.map((book, i) => (
            <div key={i} className=" align-items-center  max-w-[28rem] max-h-[20rem] h-[20vmin] sm:h-[15vmin] md:h-[15vmin] lg:h-[15vmin] xl:h-[15vmin] flex flex-wrap  flex-row justify-around rounded-md bg-white shadow-md">
            ...
            <div className="relative block overflow-hidden justify-items-start ">
                <h6 className=" block font-sans text-md text-ellipsis overflow-hidden sm:text-lg md:text-2xl lg:text-3xl xl:text-3xl truncate font-semibold uppercase leading-relaxed tracking-normal text-pink-500 ">
                   {book.desc}
                </h6>
