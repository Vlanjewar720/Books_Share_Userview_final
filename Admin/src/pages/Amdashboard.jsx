  ...
  return (
    <div className="2xl:container mx-auto">
      ...
      <div
        className={`${
          open
            ? "  xl:w-64 w-10 h-[90vh]  ps-1 pe-1 top-24  fixed  text-white  bg-[#1f2937] rounded"
            : "w-10 max-h-full lg:w-10  ps-1 pe-1 h-[90vh] xl:w-12   top-24  sm:w-10 fixed  bg-[#1f2937] rounded"
        } `}
        id="main"
      >
        <img
      ...
      <div
        className={`${
          open
            ...
            : "xl:pl-14 pl-10 transition-all duration-200"
        }`}
      >
        <Adashboard/>
      </div>
